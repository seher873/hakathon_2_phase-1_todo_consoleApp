...
- **User Interaction**: The system prompts the user for the task ID and confirms deletion
...
- **Display Format**: Each task shows ID, title, description, and completion status (e.g., [X] for complete)
...
- **FR-009**: System MUST handle invalid inputs and display appropriate error messages
...
- **SC-002**: Users can complete any task management operation in under 30 seconds
